...
function write(){
       textSize=1.5
       text("In this game you are a Dinosaur named Donny training to reach the highest score possible in the annual dino race",width/2, height/2)
       text("can you reach a score of 1 million and help Donny win the race? Lets find out!",width/2, height-300)
